...
## Crowdin Enterprise Feature & Role Access Matrix

| Feature / Capability | Owner | Admin | Workspace Manager | Group Manager | Project Manager | Developer / Requestor | Language Coordinator | Proofreader | Translator | Vendor |
|----------------------|:-----:|:-----:|:-----------------:|:-------------:|:---------------:|:---------------------:|:--------------------:|:----------:|:----------:|:------:|
| Organization-level settings | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ |
| Subscription & billing | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ |
| Manage users & roles | ✅ | ✅ | ⚠️ Limited | ⚠️ Limited | ⚠️ Limited | ❌ | ❌ | ❌ | ❌ | ❌ |
| Security settings (SSO, 2FA, IP allowlist) | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ |
| Create / manage groups | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ |
| Create / manage projects | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ |
| Workflow templates & configuration | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ |
| Workflow automation & steps | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ |
| Upload & manage source files | ✅ | ✅ | ✅ | ✅ | ❌ | ✅ | ❌ | ❌ | ❌ | ⚠️ Limited |
| Integrations & API setup | ✅ | ✅ | ✅ | ✅ | ❌ | ✅ | ❌ | ❌ | ❌ | ❌ |
| Apps / plugins installation | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ |
| Translation Memory & Glossaries | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ |
| Machine Translation / AI setup | ✅ | ✅ | ✅ | ✅ | ⚠️ Limited | ❌ | ❌ | ❌ | ❌ | ❌ |
| AI provider configuration | ✅ | ✅ | ✅ | ✅ | ⚠️ Limited | ❌ | ❌ | ❌ | ❌ | ❌ |
| Branches & version management | ✅ | ✅ | ✅ | ✅ | ❌ | ✅ | ❌ | ❌ | ❌ | ❌ |
| Invite users to projects | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ |
| Assign project roles | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ⚠️ Languages only | ❌ | ❌ | ❌ |
| Translation Editor access | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| Submit translations | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ⚠️ Assigned steps |
| Approve / reject translations | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ✅ | ✅ | ❌ | ⚠️ Assigned steps |
| Create & manage tasks | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ✅ | ❌ | ❌ | ❌ |
| Reports & statistics | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ✅ | ❌ | ❌ | ❌ |
| Vendor-specific workflow access | — | — | — | — | ⚠️ | ❌ | ❌ | ❌ | ❌ | ✅ |
